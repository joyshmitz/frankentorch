...
fn fnv(v: &[f64]) -> u64 { let mut a=0xcbf29ce484222325u64; for x in v { a=(a^x.to_bits()).wrapping_mul(0x100000001b3);} a }
fn main() {
    for &(m,k,n) in &[(256usize,64usize,16384usize),(64usize,256usize,8192usize)] {
