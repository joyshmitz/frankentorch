...
fn main() {
    ...
    all &= run("LO2", vec![1.41421356, 0.0, 0.35355339, 1.17260394], 2, vec![1.0, 2.0], false,
        &[-0.385694611, -0.658984036, -1.285648695, -1.628078197]);
    // upper 2x2
    all &= run("UP2", vec![1.41421356, 0.35355339, 0.0, 1.17260394], 2, vec![1.0, 2.0], true,
        &[-0.385694611, -1.285648695, -0.658984036, -1.628078197]);
    // lower 3x3
    all &= run("LO3", vec![2.0, 0.0, 0.0, 0.5, 1.5, 0.0, 0.3, 0.4, 1.2], 3, vec![1.0, 2.0, 3.0], false,
        &[-0.023341049, -0.109375, -0.21169303, -0.274691358, -0.416666667, -0.605195473,
          -1.053240741, -1.354166667, -1.793016975]);
