...
//! batch_norm_apply_f32 fwd, batch_norm_backward_f32 bwd). Fresh session/iter.
...
fn main() {
    ...
    eprintln!("batch_norm2d f32 fwd+bwd [{n},{c},{h}x{w}]: composed {bo:.2} ms / fused {bn:.2} ms / speedup {:.2}x", bo / bn);
}
